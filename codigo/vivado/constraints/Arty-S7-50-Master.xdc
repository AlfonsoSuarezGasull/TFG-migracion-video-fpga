...
set_property PACKAGE_PIN P17 [get_ports HDMI_D2_P] 
set_property IOSTANDARD TMDS_33 [get_ports HDMI_D2_P] 

set_property PACKAGE_PIN R18 [get_ports HDMI_D0_P] 
set_property IOSTANDARD TMDS_33 [get_ports HDMI_D0_P]
 
set_property PACKAGE_PIN P14 [get_ports HDMI_D1_P] 
set_property IOSTANDARD TMDS_33 [get_ports HDMI_D1_P] 

set_property PACKAGE_PIN N15 [get_ports HDMI_CLK_P] 
...
set_property PACKAGE_PIN U15 [get_ports RESETCAM]
set_property PACKAGE_PIN V16 [get_ports {datain[0]}]
set_property PACKAGE_PIN U17 [get_ports {datain[2]}]
set_property PACKAGE_PIN U18 [get_ports {datain[4]}]
set_property PACKAGE_PIN P13 [get_ports {datain[1]}]
set_property PACKAGE_PIN R13 [get_ports {datain[3]}]
set_property PACKAGE_PIN V14  [get_ports {datain[5]}]

## Pmod Header JD

set_property  PACKAGE_PIN V15 [get_ports {datain[6]}]
set_property  PACKAGE_PIN U12 [get_ports xclk]
set_property  PACKAGE_PIN V13 [get_ports href]
set_property  PACKAGE_PIN T12 [get_ports IIC_0_sda_io]
set_property  PACKAGE_PIN T13 [get_ports pclk]
set_property  PACKAGE_PIN R11 [get_ports {datain[7]}]
set_property  PACKAGE_PIN T11 [get_ports vsync]
set_property  PACKAGE_PIN U11 [get_ports IIC_0_scl_io]
...
set_property PULLUP true [get_ports RESETCAM]
## USB-UART Interface
...
#set_property CLOCK_DEDICATED_ROUTE TRUE [get_nets design_1_i/clk_wiz_1/inst/clk_out100]
#set_property CLOCK_DEDICATED_ROUTE TRUE [get_nets design_1_i/clk_wiz_1/inst/clk_out25]
...
# Forzar a Vivado a ignorar las restricciones de tiempo estrictas en la interfaz de control del bloque HLS
set_false_path -through [get_pins -hierarchical -filter {NAME =~ *Procesador_Video_0/U0/*CONTROL_s_axi*}]
